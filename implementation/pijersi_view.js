...
pijersi.view.make_label_divs = function(hexagons){
    ...
    for ( const hexagon of hexagons ) {
        ...
        label_div.style.left = (x_hexagon_div - 0*label_div_width)/pijersi.view.const.BOARD_WIDTH*100 + "%";
        label_div.style.top = (y_hexagon_div + pijersi.view.const.HEXA_HEIGHT/2)/pijersi.view.const.BOARD_HEIGHT*100 + "%";

        label_div.style.height = (pijersi.view.const.HEXA_SIDE/2)/pijersi.view.const.BOARD_HEIGHT*100 + "%";
